class ServiceList extends React.Component {
  ...
  componentDidMount() {
	...
	$(id  + ' .services').eq(0).on("mouseenter",function(e){
	  e.stopPropagation(); 
      $(id  + ' .services .carousel-control-prev-icon1').removeClass("d-none"); 
      $(id  + ' .services .carousel-control-next-icon1').removeClass("d-none");  	
	});
	$(id  + ' .services').eq(0).on("mouseleave",function(e){
      $(id  + ' .services .carousel-control-prev-icon1').addClass("d-none"); 
      $(id  + ' .services .carousel-control-next-icon1').addClass("d-none");  	    
	});	  
  }
