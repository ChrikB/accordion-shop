class ServiceBrandList extends React.Component {	
  constructor(props) {
  	super();	
	this.serviceBrandList = props.serviceBrandList;
  }
  ...
  render() { 	
    ...
    components = this.serviceBrandList.map((b,k) => {
      return <ServiceBrand 
			   param={b} 
	...
	carouselId = 'carousel-service-brand' + this.props.index;
